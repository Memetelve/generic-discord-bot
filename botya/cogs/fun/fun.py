...
class Fun(
    commands.Cog, name="Fun", description="Commands for fun, with no real purpose ;)"
):
    def __init__(self, bot: commands.Bot):
        self.bot = bot

    @app_commands.command(name="8ball", description="Ask the magic 8ball a question!")
    @app_commands.describe(question="The question you want to ask the magic 8ball.")
    async def eight_ball(self, interaction: discord.Interaction, question: str) -> None:
        # create embed with random response
        embed = Embed(
            title=f'"{question}"',
            description=random.choice(eight_ball_responses),
            color=0x008CFF,
        )
    ...
    async def coinflip(self, interaction: discord.Interaction) -> None:
        ...
        embed = Embed(
            ...
            description="This is your coinflip result!",
            color=0x000000,
            author=[interaction.user.name, interaction.user.avatar.url],
        )
    ...
    async def dice(self, interaction: discord.Interaction) -> None:
        # create embed with random response
        embed = Embed(
            title=f"**{random.randint(1, 6)}**",
            description="This is your dice roll result!",
            color=0x000000,
            author=[interaction.user.name, interaction.user.avatar.url],
        )
    ...
    @app_commands.command(name="fortune", description="Get a fortune!")
    async def fortune(self, interaction: discord.Interaction) -> None:
        # create embed with random response
        embed = Embed(
            title=f"**{random.choice(fortune_cookie_responses)}**",
